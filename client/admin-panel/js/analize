...
class QuotesManager {
    ...
    async fetchQuotes() {
        const params = new URLSearchParams({
            ...
            isAdmin: 'true', // Admin sees all quotes
            ...this.filters
        });
    ...
    async fetchStatistics() {
        const response = await fetch(`${this.apiPrefix}/quotes/statistics?period=${this.filters.period}&isAdmin=true`);
    ...
    async fetchAnalytics() {
        const response = await fetch(`${this.apiPrefix}/quotes/analytics?period=${this.filters.period}&isAdmin=true`);
    ...
    async viewQuote(quoteId) {
        try {
            ...
            const response = await fetch(`${this.apiPrefix}/quotes/${quoteId}?isAdmin=true`);
    ...
    async analyzeQuote(quoteId) {
        try {
            ...
            const response = await fetch(`${this.apiPrefix}/quotes/${quoteId}/analyze?isAdmin=true`, {
                method: 'POST'
            });
    ...
    async exportQuotes() {
        try {
            ...
            const response = await fetch(`${this.apiPrefix}/quotes/export?isAdmin=true`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async findSimilarQuotes(quoteId) {
        try {
            ...
            const response = await fetch(`${this.apiPrefix}/quotes/search/similar/${quoteId}?isAdmin=true`);
