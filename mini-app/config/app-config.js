...
const AppConfig = {
    ...
    /**
     * Настройки лент сообщества
     * @type {Object}
     */
    feeds: {
        /**
         * Настройки для страницы сообщества
         */
        community: {
            /**
             * Настройки spotlight (карусель "Сейчас в сообществе")
             */
            spotlight: {
                targetCount: 12,                        // Целевое количество карточек
                ratio: { latest: 1, favorites: 1 },    // Соотношение свежих/избранных (50/50)
                fallback: ['popularFavorites', 'popular'], // Фоллбэк при нехватке данных
                ttlMs: 10 * 60 * 1000                  // TTL кеша (10 минут)
            },
            /**
             * Настройки основной ленты ("Все")
             */
            feed: {
                initialCount: 12,                      // Начальное количество цитат
                loadMoreStep: 6,                       // Количество цитат при "Показать ещё"
                interleavePattern: [3, 'anna', 5, 'trend', 'rest'] // Паттерн вставок
            },
            /**
             * Настройки ленты подписок ("От подписок")
             */
            following: {
                initialCount: 12,                      // Начальное количество цитат
                loadMoreStep: 6,                       // Количество цитат при "Показать ещё"
                interleaveInserts: false               // Не вставлять блоки в ленту подписок
            }
        }
    },
