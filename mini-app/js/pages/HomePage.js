...
class HomePage {
        ...
        if (grid) {
            ...
            if (isLoading) {
                ...
                if (row2) {
                    ...
                    // Calculate streak from stats.currentStreak (no minimum)
                    const currentStreak = stats.currentStreak ?? stats.streak ?? 0;
                    const displayStreak = (typeof currentStreak === 'number') ? currentStreak : 0;
    ...
    renderUserHeader(user) {
        ...
        const badgeHtml = hasAlice 
            ? '<span class="badge-inline-stack"><img src="/assets/badges/alice.png" alt="Бейдж «Алиса»" title="Бейдж «Алиса в стране чудес»" class="badge-inline badge-inline--alice" onerror="this.src=\'/assets/badges/alice.png\'" /></span>' 
            : '';
