...
class CatalogPage {
    ...
    async loadCatalogData() {
        ...
        try {
            ...
            // Fallback на статичные данные при ошибке для тестирования обложек
            this.books = [
                {
                    id: '1',
                ...
                },
                {
                    ...
                    description: 'Как выжить в мире, который рушится, сохранив семью и желание жить',
                    price: '100 BYN',
                    bookSlug: 'grozdya_gneva',
                    coverClass: 'cover-2',
                    categories: ['КРИЗИСЫ']
                },
                {
                    ...
                    description: 'Классический роман о добре, зле и человеческой природе',
                    price: '120 BYN',
                    bookSlug: 'idiot',
                    coverClass: 'cover-3',
                    categories: ['ДОБРО И ЗЛО']
                },
                {
                    id: '4',
                    title: 'Искусство любить',
                    author: 'Эрих Фромм',
                    description: 'Практическое руководство по пониманию любви как искусства',
                    price: '90 BYN',
                    bookSlug: 'iskusstvo_lyubit',
                    coverClass: 'cover-4',
                    categories: ['ЛЮБОВЬ', 'ОТНОШЕНИЯ']
                },
                {
                    id: '5',
                    title: 'Тестовая книга без обложки',
                    author: 'Автор тест',
                    description: 'Эта книга для тестирования fallback без картинки',
                    price: '80 BYN',
                    bookSlug: 'test_no_cover_book',
                    coverClass: 'cover-5',
                    categories: ['ПОИСК СЕБЯ']
                }
            ];
            console.log('📚 CatalogPage: Используем тестовые данные для демонстрации обложек.');
        } finally {
            this.catalogLoading = false;
            this.rerender();
