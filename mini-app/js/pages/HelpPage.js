 ...
 * Функциональность:
 * - Руководство пользователя (7 шагов)
                ...
                <div class="guide-steps">
                    <div class="guide-step">
                        ...
                        <div class="step-content">
                            <h4>Добавляйте цитаты</h4>
                            <p>Вы можете добавлять до 10 цитат в день. Комментарий к цитате формируется с небольшой задержкой — это нормально.</p>
                        </div>
                    </div>
                    ...
                    <div class="guide-step">
                        ...
                        <div class="step-content">
                            <h4>Управляйте дневником</h4>
                            <p>Используйте фильтры: Неделя, Месяц, Избранное. Редактируйте и удаляйте свои цитаты. Добавляйте в избранное через лайк.</p>
                        </div>
                    </div>
                    ...
                    <div class="guide-step">
                        ...
                        <div class="step-content">
                            <h4>Поддерживайте серию</h4>
                            <p>Серия — это количество дней подряд, когда Вы добавили хотя бы одну цитату. Если пропустите день, серия обнулится.</p>
                        </div>
                    </div>
                    ...
                    <div class="guide-step">
                        ...
                        <div class="step-content">
                            <h4>Изучайте ленту</h4>
                            <p>В Ленте Вы найдете последние цитаты, избранное пользователей, тренд недели, купленные разборы книг, топы недели по пользователям и цитатам, а также общую статистику.</p>
                        </div>
                    </div>
                    ...
                    <div class="guide-step">
                        ...
                        <div class="step-content">
                            <h4>Получайте еженедельный отчёт</h4>
                            <p>Каждую неделю Ваши цитаты классифицируются по темам. На основе анализа формируется отчёт с комментариями и рекомендациями книг.</p>
                        </div>
                    </div>
                    ...
                    <div class="guide-step">
                        ...
                        <div class="step-content">
                            <h4>Пользуйтесь каталогом</h4>
                            <p>Каталог показывает ТОП-3 разбора недели (обновляется еженедельно) и рекомендации по темам из последнего отчёта. Вы можете перейти на сайт Анны для покупки.</p>
                        </div>
                    </div>
                    ...
                    <div class="guide-step">
                        ...
                        <div class="step-content">
                            <h4>Настраивайте профиль</h4>
                            <p>В настройках Вы можете: загрузить аватар, изменить email, пройти тест заново, настроить уведомления, удалить профиль. За активность получайте достижения!</p>
                        </div>
                    </div>
                </div>
            </div>
