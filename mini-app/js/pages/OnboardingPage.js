        ...
        return `
            <div class="welcome-screen">
                ...
                <div class="welcome-description">
                    Вы попали в «Читатель» — сообщество читающих и мыслящих людей.
                    <br><br>
                    Меня зовут Анна Бусел, я являюсь практикующим психологом 
                    и основателем проекта "Книжный клуб от психолога" 
        ...
        return `
            <div class="contact-form" style="margin-top: 20px;">
                <div class="form-group">
                    <label class="form-label">📧 Email (Обязательно)</label>
                    <input class="question-input" 
                           id="emailInput"
                           type="email"
