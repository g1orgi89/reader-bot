/**
 * Точка входа для запуска Telegram бота Shrooms
...
const ShroomsTelegramBot = require('./index');
...
async function startTelegramBot() {
  try {
    ...
    logger.info('🍄 Starting Shrooms Telegram Bot...');
    ...
    const bot = new ShroomsTelegramBot({
      token: telegramToken,
    ...
    logger.info('🍄 Shrooms Telegram Bot is running!');
