...
class SimpleTelegramBot {
  ...
  _setupCommands() {
    ...
    this.bot.start(async (ctx) => {
      ...
      try {
        const usageMessage = `📚 Как пользоваться приложением (ВАЖНО! ПРОЧТИТЕ ДО КОНЦА)
          ...
          Чтобы начать, нажмите синюю кнопку внизу Telegram и откройте мини-приложение.
          Пройдите короткий тест -  и вам откроется доступ к личному читательскому пространству.
      
          Если что-то будет непонятно, <b>нажмите «…» в правом верхнем углу главной страницы и выберите раздел «Помощь» 🪶
