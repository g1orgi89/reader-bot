...
class SimpleTelegramBot {
  ...
  _setupCommands() {
    ...
    this.bot.start(async (ctx) => {
      ...
      try {
        const usageMessage = `📚 <b>Как пользоваться приложением (ВАЖНО! ПРОЧТИТЕ ДО КОНЦА)<b>
          ...
          Здесь вы сможете <b>видеть, как меняетесь через чтение книг.<b>
          Добавляйте цитаты каждый день - и по воскресеньям получайте отчёт о том, на чём сейчас <b>сосредоточено ваше внимание<b>.
          
          Загляните в раздел «Каталог» - там можно выбрать книгу для покупки и разбора.
          А в разделе «<b>Сообщество<b>» вы найдёте цитаты других участников: ставьте лайки ❤️, сохраняйте понравившиеся, вдохновляйтесь.
          
          Так мы вместе формируем пространство, где чтение становится способом меняться и расти 🌿
      
          Чтобы начать, нажмите <b>синюю кнопку<b> внизу <b>Telegram<b> и откройте мини-приложение.
          Пройдите короткий тест -  и вам откроется доступ к личному читательскому пространству.
      
          Если что-то будет непонятно, <b>нажмите «…»<b> в правом верхнем углу главной страницы и выберите раздел «<b>Помощь<b>» 🪶
          
          ✅ Я буду время от времени <b>напоминать<b> вам о приложении, чтобы чтение и сохранение цитат вошли в привычку.
          А те, кто будет пользоваться им каждый день в течение месяца и дольше, <b>получат от меня особые предложения и подарки<b> 🎁
          
          Пусть это приложение станет частью вашего читательского опыта и личной истории.
        `.replace(/^[ \t]+/gm, '').trim(); // ← убираем лидирующие пробелы и крайние пустые строки
