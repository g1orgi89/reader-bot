...
const CANONICAL_CATEGORIES = [
  ...
  },
  {
    key: 'СМЫСЛ ЖИЗНИ',
    slug: 'meaning',
    synonyms: ['смысл жизни', 'предназначение', 'цель', 'миссия', 'призвание', 'суть', 'философия'],
  ...
  },
  {
    key: 'СЧАСТЬЕ',
    slug: 'happiness',
    synonyms: ['счастье', 'радость', 'веселье', 'удовольствие', 'блаженство', 'позитив', 'эйфория'],
  ...
  },
  {
    key: 'ПОИСК СЕБЯ',
    slug: 'self-discovery',
    synonyms: ['самопознание', 'саморазвитие', 'поиск себя', 'путь', 'рост', 'развитие', 'познание', 'самосовершенствование', 'личностный рост'],
