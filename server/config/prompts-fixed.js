/**
 * Исправления для Shrooms Support Bot v1.1
...
- Для несвязанных вопросов отвечай: "Я специализируюсь исключительно на помощи с проектом Shrooms. Пожалуйста, задавайте вопросы о нашей платформе, токенах SHROOMS, стейкинге, фарминге или других функциях нашего грибного королевства."
...
"Я специализируюсь исключительно на помощи с проектом Shrooms. В доступной мне грибной документации есть информация только о нашей платформе. Для вопросов о других проектах рекомендую обратиться к соответствующим ресурсам."
...
// Ответы на несвязанные темы
const OFF_TOPIC_RESPONSES = {
  en: `🍄 I specialize exclusively in helping with the Shrooms project. Please ask questions about our platform, SHROOMS tokens, staking, farming, or other features of our fungal kingdom. For general crypto questions, I recommend consulting specialized resources.`,
  
  ru: `🍄 Я специализируюсь исключительно на помощи с проектом Shrooms. Пожалуйста, задавайте вопросы о нашей платформе, токенах SHROOMS, стейкинге, фарминге или других функциях нашего грибного королевства. Для общих вопросов о криптовалютах рекомендую обратиться к специализированным ресурсам.`,
  
  es: `🍄 Me especializo exclusivamente en ayudar con el proyecto Shrooms. Por favor, haz preguntas sobre nuestra plataforma, tokens SHROOMS, staking, farming u otras características de nuestro reino fúngico. Para preguntas generales sobre crypto, recomiendo consultar recursos especializados.`
};
