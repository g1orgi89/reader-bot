...
userProfileSchema.statics = {
   ...
   * 🚨 ПОТЕНЦИАЛЬНАЯ ПРОБЛЕМА: Race condition при одновременных запросах
   * может создать дубликаты пользователей
   * TODO: Использовать findOneAndUpdate с upsert: true для атомарности
