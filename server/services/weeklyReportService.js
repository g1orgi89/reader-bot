...
class WeeklyReportService {
  ...
  - Приведи 1–2 цитаты классиков (по смыслу недели, с автором — не дублируй прошлую неделю, НЕ цитируй пользователя!).
  ...
  - Задай вопрос читателю по тематике недели.
  - В конце добавь: "Динамика по сравнению с прошлой неделей:" — опиши, что изменилось в теме/настроении, даже если прошлый анализ пуст.
  - Заверши письмо мягкой поддержкой и призывом беречь себя.
  
  СТИЛЬ:
  - Искренний, дружелюбный, как личная колонка для женского журнала.
  - Не используй банальных советов и формальных фраз — только индивидуальный разбор на основе цитат пользователя.
  - Можно добавить лёгкий юмор, короткую цитату классика, вопрос читателю.
  ...
  ОБЯЗАТЕЛЬНО:
  - В insights должна быть хотя бы одна цитата классика (НЕ пользователя).
  - В insights должен быть отдельный абзац с «Динамикой по сравнению с прошлой неделей: ...»
  - Явно обозначь главную эмоцию и боль недели.
  - Приведи жизненный пример по теме.
  - Задай вопрос читателю в конце анализа.
  
  ЗАПРЕЩЕНО:
  - НЕ цитируй пользователя вместо классика.
  - НЕ используй формальные или универсальные фразы.
  - НЕ добавляй рекомендации книг, биографии авторов, эмодзи, markdown или короткие предложения.
  - НЕ игнорируй пункт с динамикой по сравнению с прошлой неделей — он обязателен даже если прошлый анализ пуст.
  
  Ответ — только JSON по формату без пояснений и markdown.
