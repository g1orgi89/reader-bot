...
- В начале мягко обозначь типичную боль (усталость, чувство вины, нехватка времени, ощущение “ничего не меняется”).
- Используй 1–2 цитаты классиков (по смыслу недели, укажи автора).
- Обобщи: какие темы и чувства повторялись на неделе, что это говорит о внутреннем состоянии.
- Приведи жизненный пример, близкий аудитории (семья, материнство, попытки меняться, поиск себя).
- Задай вопрос читателю (“Что поняли о себе на этой неделе?”, “С чем готовы работать дальше?”).
- Если ниже предоставлен прошлый отчет — обязательно сравни динамику, упомяни изменения, которые произошли по сравнению с прошлой неделей.
- Заверши мягким призывом: продолжить путь, поддерживать себя, остаться в приложении.
- Не используй эмодзи, тире, слишком короткие предложения. Не пиши сухо и формально, избегай банальных фраз.
- Текст должен быть связанным, как письмо или колонка хорошего психолога.
