...
2. ГЛУБИННЫЙ ПСИХОЛОГИЧЕСКИЙ АНАЛИЗ (2-3 абзаца):
   ...
   - Добавь 1 цитату классика (НЕ пользователя!) которая отражает суть месяца
...
3. Добавь 1 цитату классика (НЕ из списка пользователя!) которая дополняет картину
4. Задай глубокий вопрос для размышления
5. Заверши мотивацией продолжать и фразой: «Хорошая жизнь строится, а не даётся по умолчанию»
